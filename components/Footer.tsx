...
const socialLinks = [
  {
    label: 'YouTube Music',
    href: 'https://music.youtube.com/channel/UCc9c4GAWF6tbSn5X_3M4jgQ?si=-qrsXfCHZeo_lkuN',
    icon: (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <h3 className="font-display font-bold text-lg text-foreground mb-4">
              Bernie aka Birdbadas
            </h3>
            <p className="text-sm text-muted-foreground">
              EDM artist from Viborg, Denmark
            </p>
          </div>
            ...
            <div className="flex flex-wrap gap-3">
              {socialLinks.map((link) => (
                <Link
                  ...
                  className="w-10 h-10 bg-background border border-border rounded-lg flex items-center justify-center text-foreground hover:bg-primary hover:text-primary-foreground transition-all hover:scale-110"
                  title={link.label}
